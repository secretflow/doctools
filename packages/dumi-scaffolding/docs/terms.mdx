...
specified in the [<strong>PEP 3333</strong>](https://peps.python.org/pep-3333/) and is widely supported.  Unlike previous solutions
...
A response object is <em>not</em> necessarily the <code>Response</code> class or a
subclass thereof.

For example Pylons/webob provide a very similar response class that can
be used as well (<code>webob.Response</code>).
