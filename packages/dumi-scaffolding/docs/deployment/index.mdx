:target{#deploying-to-production}
...
:target{#self-hosted-options}

## Self-Hosted Options

Werkzeug is a WSGI <em>application</em>. A WSGI <em>server</em> is used to run the
...
<TableOfContents>
  ...
  - [Waitress](waitress.mdx)
  - [mod\_wsgi](mod_wsgi.mdx)
  - [uWSGI](uwsgi.mdx)
  - [gevent](gevent.mdx)
  - [eventlet](eventlet.mdx)
</TableOfContents>
...
<TableOfContents>
  ...
  - [Tell Werkzeug it is Behind a Proxy](proxy_fix.mdx)
  - [nginx](nginx.mdx)
  - [Apache httpd](apache-httpd.mdx)
</TableOfContents>
...
You’ll probably need to [Tell Werkzeug it is Behind a Proxy](proxy_fix.mdx) when using most hosting
platforms.
