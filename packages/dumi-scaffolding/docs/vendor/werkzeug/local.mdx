  ...
  <Outline.Content>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          <Outline.ParameterTarget>context\_var</Outline.ParameterTarget> (<em>ContextVar</em><em>\[</em>[<em>list</em>](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.11)")<em>\[</em><em>T</em><em>]</em><em>] </em><em>| </em><em>None</em>) – The [`ContextVar`](https://docs.python.org/3/library/contextvars.html#contextvars.ContextVar "(in Python v3.11)") to use as
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              [<em>LocalProxy</em>](#werkzeug.local.LocalProxy "werkzeug.local.LocalProxy")
            </dd>
          </dl>
        </FieldList>
      </Outline.Content>
