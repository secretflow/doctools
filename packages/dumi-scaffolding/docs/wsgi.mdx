...
<Outline domain="py" objectType="class" target={"werkzeug.wsgi.FileWrapper"} module={"werkzeug.wsgi"} fullname={"FileWrapper"} parameters={["file", "buffer_size"]} description={"This class can be used to convert a file-like object into\nan iterable.  It yields buffer_size blocks until the file is fully\nread."}>
  ...
  <Outline.Content>
    This class can be used to convert a <code>file</code>-like object into
    an iterable.  It yields <cite>buffer\_size</cite> blocks until the file is fully
    read.

    You should not use this class directly but rather use the
    [<code>wrap\_file()</code>](#werkzeug.wsgi.wrap_file "werkzeug.wsgi.wrap_file") function that uses the WSGI server’s file wrapper
    ...
    If you’re using this object together with a <code>Response</code> you have
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <Outline.ParameterTarget>file</Outline.ParameterTarget> (<em>t.IO</em><em>\[</em>[<em>bytes</em>](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.11)")<em>]</em>) – a <code>file</code>-like object with a <code>read()</code> method.
...
<Outline domain="py" objectType="class" target={"werkzeug.wsgi.LimitedStream"} module={"werkzeug.wsgi"} fullname={"LimitedStream"} parameters={["stream", "limit", "is_max"]} description={"Wrap a stream so that it doesn\u2019t read more than a given limit. This is used to\nlimit wsgi.input to the Content-Length header value or\nRequest.max_content_length."}>
  ...
  <Outline.Content>
    ...
    limit <code>wsgi.input</code> to the <code>Content-Length</code> header value or
    [<code>Request.max\_content\_length</code>](wrappers.mdx#werkzeug.wrappers.Request.max_content_length "werkzeug.wrappers.Request.max_content_length").

    When attempting to read after the limit has been reached, [<code>on\_exhausted()</code>](#werkzeug.wsgi.LimitedStream.on_exhausted "werkzeug.wsgi.LimitedStream.on_exhausted") is
    called. When the limit is a maximum, this raises [<code>RequestEntityTooLarge</code>](exceptions.mdx#werkzeug.exceptions.RequestEntityTooLarge "werkzeug.exceptions.RequestEntityTooLarge").

    If reading from the stream returns zero bytes or raises an error,
    [<code>on\_disconnect()</code>](#werkzeug.wsgi.LimitedStream.on_disconnect "werkzeug.wsgi.LimitedStream.on_disconnect") is called, which raises [<code>ClientDisconnected</code>](exceptions.mdx#werkzeug.exceptions.ClientDisconnected "werkzeug.exceptions.ClientDisconnected"). When the
      ...
      <dl>
        ...
        <dd className="field-body">
          ...
          - <Outline.ParameterTarget>limit</Outline.ParameterTarget> ([<em>int</em>](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")) – The limit in bytes to not read past. Should be either the
            <code>Content-Length</code> header value or <code>request.max\_content\_length</code>.
          - <Outline.ParameterTarget>is\_max</Outline.ParameterTarget> ([<em>bool</em>](https://docs.python.org/3/library/functions.html#bool "(in Python v3.11)")) – Whether the given <code>limit</code> is <code>request.max\_content\_length</code> instead
            of the <code>Content-Length</code> header value. This changes how exhausted and
    ...
    <Container type="info" title="Version changed">
      <span>Changed in version 2.3: </span>Handle <code>max\_content\_length</code> differently than <code>Content-Length</code>.
    </Container>

    <Container type="info" title="Version changed">
      <span>Changed in version 2.3: </span>Implements <code>io.RawIOBase</code> rather than <code>io.IOBase</code>.
    </Container>
    ...
    <Outline domain="py" objectType="method" target={"werkzeug.wsgi.LimitedStream.on_disconnect"} module={"werkzeug.wsgi"} fullname={"LimitedStream.on_disconnect"} parameters={["error"]} description={"Called when an attempted read receives zero bytes before the limit was\nreached. This indicates that the client disconnected before sending the full\nrequest body."}>
      ...
      <Outline.Content>
        ...
        The default behavior is to raise [<code>ClientDisconnected</code>](exceptions.mdx#werkzeug.exceptions.ClientDisconnected "werkzeug.exceptions.ClientDisconnected"), unless the limit is
        a maximum and no error was raised.

        <Container type="info" title="Version changed">
          <span>Changed in version 2.3: </span>Added the <code>error</code> parameter. Do nothing if the limit is a maximum and no
          error was raised.
        </Container>
    ...
    <Outline domain="py" objectType="method" target={"werkzeug.wsgi.LimitedStream.on_exhausted"} module={"werkzeug.wsgi"} fullname={"LimitedStream.on_exhausted"} parameters={[]} description={"Called when attempting to read after the limit has been reached."}>
      ...
      <Outline.Content>
        ...
        case it raises [<code>RequestEntityTooLarge</code>](exceptions.mdx#werkzeug.exceptions.RequestEntityTooLarge "werkzeug.exceptions.RequestEntityTooLarge").

        <Container type="info" title="Version changed">
          <span>Changed in version 2.3: </span>Raises <code>RequestEntityTooLarge</code> if the limit is a maximum.
        </Container>
...
<Outline domain="py" objectType="function" target={"werkzeug.wsgi.make_line_iter"} module={"werkzeug.wsgi"} fullname={"make_line_iter"} parameters={["stream", "limit", "buffer_size", "cap_at_buffer"]} description={"Safely iterates line-based over an input stream.  If the input stream\nis not a LimitedStream the limit parameter is mandatory."}>
  <Outline.Signature fullname="make_line_iter" id="werkzeug.wsgi.make_line_iter">
    <Outline.Prefix>werkzeug.wsgi.</Outline.Prefix><Outline.Name>make\_line\_iter</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">stream</span></Outline.Parameter>, <Outline.Parameter><span className="name">limit</span><span>=</span><span>None</span></Outline.Parameter>, <Outline.Parameter><span className="name">buffer\_size</span><span>=</span><span>10240</span></Outline.Parameter>, <Outline.Parameter><span className="name">cap\_at\_buffer</span><span>=</span><span>False</span></Outline.Parameter><span>)</span></Outline.ParameterList>
  </Outline.Signature>

  <Outline.Content>
    Safely iterates line-based over an input stream.  If the input stream
    is not a [<code>LimitedStream</code>](#werkzeug.wsgi.LimitedStream "werkzeug.wsgi.LimitedStream") the <cite>limit</cite> parameter is mandatory.

    This uses the stream’s <code>read()</code> method internally as opposite
    to the <code>readline()</code> method that is unsafe and can only be used
    in violation of the WSGI specification.  The same problem applies to the
    <cite>\_\_iter\_\_</cite> function of the input stream which calls <code>readline()</code>
    without arguments.
    ...
    <Container type="info" title="Version added">
      <span>New in version 0.11: </span>added support for the <cite>cap\_at\_buffer</cite> parameter.
    </Container>

    <Container type="info" title="Version added">
      <span>New in version 0.9: </span>added support for iterators as input stream.
    </Container>

    <Container type="info" title="Version changed">
      <span>Changed in version 0.8: </span>This function now ensures that the limit was reached.
    </Container>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <Outline.ParameterTarget>stream</Outline.ParameterTarget> (<em>t.Iterable</em><em>\[</em>[<em>bytes</em>](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.11)")<em>] </em><em>| </em><em>t.IO</em><em>\[</em>[<em>bytes</em>](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.11)")<em>]</em>) – the stream or iterate to iterate over.
          - <Outline.ParameterTarget>limit</Outline.ParameterTarget> ([<em>int</em>](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")<em> | </em><em>None</em>) – the limit in bytes for the stream.  (Usually
            content length.  Not necessary if the <cite>stream</cite>
            is a [<code>LimitedStream</code>](#werkzeug.wsgi.LimitedStream "werkzeug.wsgi.LimitedStream").
          - <Outline.ParameterTarget>buffer\_size</Outline.ParameterTarget> ([<em>int</em>](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")) – The optional buffer size.
          - <Outline.ParameterTarget>cap\_at\_buffer</Outline.ParameterTarget> ([<em>bool</em>](https://docs.python.org/3/library/functions.html#bool "(in Python v3.11)")) – if this is set chunks are split if they are longer
        ...
        <dd className="field-body">
          t.Iterator\[[bytes](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.11)")]
        </dd>
      </dl>
    </FieldList>
  </Outline.Content>
...
<Outline domain="py" objectType="function" target={"werkzeug.wsgi.make_chunk_iter"} module={"werkzeug.wsgi"} fullname={"make_chunk_iter"} parameters={["stream", "separator", "limit", "buffer_size", "cap_at_buffer"]} description={"Works like make_line_iter() but accepts a separator\nwhich divides chunks.  If you want newline based processing\nyou should use make_line_iter() instead as it\nsupports arbitrary newline markers."}>
  <Outline.Signature fullname="make_chunk_iter" id="werkzeug.wsgi.make_chunk_iter">
    <Outline.Prefix>werkzeug.wsgi.</Outline.Prefix><Outline.Name>make\_chunk\_iter</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">stream</span></Outline.Parameter>, <Outline.Parameter><span className="name">separator</span></Outline.Parameter>, <Outline.Parameter><span className="name">limit</span><span>=</span><span>None</span></Outline.Parameter>, <Outline.Parameter><span className="name">buffer\_size</span><span>=</span><span>10240</span></Outline.Parameter>, <Outline.Parameter><span className="name">cap\_at\_buffer</span><span>=</span><span>False</span></Outline.Parameter><span>)</span></Outline.ParameterList>
  </Outline.Signature>

  <Outline.Content>
    Works like [<code>make\_line\_iter()</code>](#werkzeug.wsgi.make_line_iter "werkzeug.wsgi.make_line_iter") but accepts a separator
    which divides chunks.  If you want newline based processing
    you should use [<code>make\_line\_iter()</code>](#werkzeug.wsgi.make_line_iter "werkzeug.wsgi.make_line_iter") instead as it
    supports arbitrary newline markers.
    ...
    <Container type="info" title="Version changed">
      <span>Changed in version 0.11: </span>added support for the <cite>cap\_at\_buffer</cite> parameter.
    </Container>

    <Container type="info" title="Version changed">
      <span>Changed in version 0.9: </span>added support for iterators as input stream.
    </Container>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <Outline.ParameterTarget>stream</Outline.ParameterTarget> (<em>t.Iterable</em><em>\[</em>[<em>bytes</em>](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.11)")<em>] </em><em>| </em><em>t.IO</em><em>\[</em>[<em>bytes</em>](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.11)")<em>]</em>) – the stream or iterate to iterate over.
          - <Outline.ParameterTarget>separator</Outline.ParameterTarget> ([<em>bytes</em>](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.11)")) – the separator that divides chunks.
          - <Outline.ParameterTarget>limit</Outline.ParameterTarget> ([<em>int</em>](https://docs.python.org/3/library/functions.html#int "(in Python v3.11)")<em> | </em><em>None</em>) – the limit in bytes for the stream.  (Usually
            content length.  Not necessary if the <cite>stream</cite>
...
<Outline domain="py" objectType="function" target={"werkzeug.wsgi.wrap_file"} module={"werkzeug.wsgi"} fullname={"wrap_file"} parameters={["environ", "file", "buffer_size"]} description={"Wraps a file.  This uses the WSGI server\u2019s file wrapper if available\nor otherwise the generic FileWrapper."}>
  ...
  <Outline.Content>
    ...
    or otherwise the generic [<code>FileWrapper</code>](#werkzeug.wsgi.FileWrapper "werkzeug.wsgi.FileWrapper").
    ...
    object you have to set <code>Response.direct\_passthrough</code> to <cite>True</cite>.
...
<Outline domain="py" objectType="function" target={"werkzeug.wsgi.get_host"} module={"werkzeug.wsgi"} fullname={"get_host"} parameters={["environ", "trusted_hosts"]} description={"Return the host for the given WSGI environment."}>
  ...
  <Outline.Content>
    ...
    The <code>Host</code> header is preferred, then <code>SERVER\_NAME</code> if it’s not
    set. The returned host will only contain the port if it is different
    than the standard port for the protocol.

    Optionally, verify that the host is trusted using
    [<code>host\_is\_trusted()</code>](#werkzeug.wsgi.host_is_trusted "werkzeug.wsgi.host_is_trusted") and raise a
    [<code>SecurityError</code>](exceptions.mdx#werkzeug.exceptions.SecurityError "werkzeug.exceptions.SecurityError") if it is not.
...
<Outline domain="py" objectType="function" target={"werkzeug.wsgi.get_content_length"} module={"werkzeug.wsgi"} fullname={"get_content_length"} parameters={["environ"]} description={"Return the Content-Length header value as an int. If the header is not given\nor the Transfer-Encoding header is chunked, None is returned to indicate\na streaming request. If the value is not an integer, or negative, 0 is returned."}>
  ...
  <Outline.Content>
    Return the <code>Content-Length</code> header value as an int. If the header is not given
    or the <code>Transfer-Encoding</code> header is <code>chunked</code>, <code>None</code> is returned to indicate
    a streaming request. If the value is not an integer, or negative, 0 is returned.
...
<Outline domain="py" objectType="function" target={"werkzeug.wsgi.get_input_stream"} module={"werkzeug.wsgi"} fullname={"get_input_stream"} parameters={["environ", "safe_fallback", "max_content_length"]} description={"Return the WSGI input stream, wrapped so that it may be read safely without going\npast the Content-Length header value or max_content_length."}>
  ...
  <Outline.Content>
    ...
    past the <code>Content-Length</code> header value or <code>max\_content\_length</code>.

    If <code>Content-Length</code> exceeds <code>max\_content\_length</code>, a
    <code>RequestEntityTooLarge\`</code> <code>413 Content Too Large</code> error is raised.

    If the WSGI server sets <code>environ\["wsgi.input\_terminated"]</code>, it indicates that the
    ...
    If <code>max\_content\_length</code> is set, it can be enforced on streams if
    <code>wsgi.input\_terminated</code> is set. Otherwise, an empty stream is returned unless the
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          ...
          - <Outline.ParameterTarget>safe\_fallback</Outline.ParameterTarget> ([<em>bool</em>](https://docs.python.org/3/library/functions.html#bool "(in Python v3.11)")) – Return an empty stream when <code>Content-Length</code> is not set.
    ...
    <Container type="info" title="Version changed">
      <span>Changed in version 2.3.2: </span><code>max\_content\_length</code> is only applied to streaming requests if the server sets
      <code>wsgi.input\_terminated</code>.
    </Container>

    <Container type="info" title="Version changed">
      <span>Changed in version 2.3: </span>Check <code>max\_content\_length</code> and raise an error if it is exceeded.
    </Container>
...
<Outline domain="py" objectType="function" target={"werkzeug.wsgi.get_current_url"} module={"werkzeug.wsgi"} fullname={"get_current_url"} parameters={["environ", "root_only", "strip_querystring", "host_only", "trusted_hosts"]} description={"Recreate the URL for a request from the parts in a WSGI\nenvironment."}>
  ...
  <Outline.Content>
    ...
    Use [<code>iri\_to\_uri()</code>](urls.mdx#werkzeug.urls.iri_to_uri "werkzeug.urls.iri_to_uri") to convert it to ASCII.
...
the <code>str</code> type to represent values. To accomplish this, the raw bytes
...
page as well as [<code>EnvironHeaders()</code>](datastructures.mdx#werkzeug.datastructures.EnvironHeaders "werkzeug.datastructures.EnvironHeaders") to read
...
The <code>PATH\_INFO</code> in the environ is the path value after
percent-decoding. For example, the raw path <code>/hello%2fworld</code> would
show up from the WSGI server to Werkzeug as <code>/hello/world</code>. This loses
...
server will add the raw value to both the <code>REQUEST\_URI</code> and
<code>RAW\_URI</code> keys. If you want to route based on this value, you can use
middleware to replace <code>PATH\_INFO</code> in the environ before it reaches the
